...
public class FancyAboutPage extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        diagonalView = (ImageView) findViewById(R.id.background);
    }
    ...
    public void setCoverTintColor(int color) {
        diagonalView.setColorFilter(color);
    }
    ...
    public void addEmailLink(final String emailAddress) {
        email.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FancyToast.makeText(getContext(), emailAddress, FancyToast.LENGTH_LONG,FancyToast.SUCCESS,R.drawable.user,true).show();
