...
import com.osepoo.angamizaactual.utils.ColorUtils;
import com.osepoo.angamizaactual.utils.WindowUtils;
...
public class TransitionButton extends AppCompatButton {
    ...
    private com.osepoo.angamizaactual.CircularAnimatedDrawable progressCircularAnimatedDrawable;
    ...
    private void drawIndeterminateProgress(Canvas canvas) {
        if (progressCircularAnimatedDrawable == null || !progressCircularAnimatedDrawable.isRunning()) {
            ...
            progressCircularAnimatedDrawable = new com.osepoo.angamizaactual.CircularAnimatedDrawable(loaderColor, arcWidth);
