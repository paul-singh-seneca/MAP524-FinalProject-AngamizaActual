...
public class HelpLine extends AppCompatActivity implements SpeechDelegate {
    ...
    private void onSetSpeechToTextLanguage() {
        Speech.getInstance().getSupportedSpeechToTextLanguages(new SupportedLanguagesListener() {
            ...
            public void onSupportedLanguages(List<String> supportedLanguages) {
                ...
                new AlertDialog.Builder(HelpLine.this)
                        ...
                        .setItems(items, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Toast.makeText(HelpLine.this, "Selected: " + items[i], Toast.LENGTH_LONG).show();
                            }
                        })
    ...
    private void onButtonClick() {
        if (Speech.getInstance().isListening()) {
            ...
            if (ContextCompat.checkSelfPermission(HelpLine.this, android.Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED) {
                onRecordAudioPermissionGranted();
            } else {
                ActivityCompat.requestPermissions(HelpLine.this, new String[]{android.Manifest.permission.RECORD_AUDIO}, PERMISSIONS_REQUEST);
            }
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode != PERMISSIONS_REQUEST) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(HelpLine.this, R.string.permission_required, Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private void onRecordAudioPermissionGranted() {
        ...
        try {
            ...
            Speech.getInstance().startListening(progress, HelpLine.this);
    ...
    private void onSpeakClick() {
        ...
        Speech.getInstance().say(textToSpeech.getText().toString().trim(), new TextToSpeechCallback() {
            @Override
            public void onStart() {
                Toast.makeText(HelpLine.this, "TTS onStart", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onCompleted() {
                Toast.makeText(HelpLine.this, "TTS onCompleted", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onError() {
                Toast.makeText(HelpLine.this, "TTS onError", Toast.LENGTH_SHORT).show();
            }
        });
    }
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case DialogInterface.BUTTON_POSITIVE:
                        SpeechUtil.redirectUserToGoogleAppOnPlayStore(HelpLine.this);
                        break;
